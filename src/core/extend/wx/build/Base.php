...
namespace bear\extend\wx\build;

use bear\sys\config\Config;
use bear\curl\Curl;
use bear\extend\dir\Dir;
use bear\extend\wx\build\common\Error;
use bear\extend\wx\build\common\Sign;
use bear\extend\wx\build\common\Xml;
use bear\extend\cache\Cache;
...
class Base extends Error
{
    ...
    {
        $class = '\bear\extend\wx\build\\' . strtolower($api) . '\\App';
